...
BINARY_NAME := component-validator
GO := GO111MODULE=on GO15VENDOREXPERIMENT=1 go
GO_NOMOD := GO111MODULE=off go
PACKAGE_NAME := github.com/garethjevans/component-validator
ROOT_PACKAGE := github.com/garethjevans/component-validator
ORG := garethjevans
...
docs: build
	./build/component-validator docs
